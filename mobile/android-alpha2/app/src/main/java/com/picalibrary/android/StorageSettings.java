...
final class StorageSettings {
    static final long UNLIMITED=-1L,DEFAULT_PAGE_MB=1024,DEFAULT_COVER_MB=256;
    ...
    private static final String PREFS="mobile-storage-v1",PAGE="pageMb",COVER="coverMb",PREFETCH_KEY="prefetchPages",CACHE_EXTERNAL="cacheExternal",DATA_EXTERNAL="dataExternal",DOWNLOAD_TREE="downloadTreeUri",DOWNLOAD_WIFI_ONLY="downloadWifiOnly";
    ...
    static boolean downloadWifiOnly(Context c){return prefs(c).getBoolean(DOWNLOAD_WIFI_ONLY,false);}
    ...
    static void setDownloadWifiOnly(Context c,boolean value){prefs(c).edit().putBoolean(DOWNLOAD_WIFI_ONLY,value).apply();}
