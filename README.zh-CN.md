...
重要升级说明：`v0.1.3 → v0.2.0` 必须下载并解压完整的 `Pica-Library-v0.2.0-windows-x64.zip`。v0.1.3 没有新的 UpdateManager，不能直接使用 v0.2.0 增量更新包。v0.2.0 将成为后续兼容版本使用内置增量 Update ZIP 流程的基线。

项目提供内置 Web Reader、ZIP/CBZ 导出和外部阅读器接口，但不捆绑第三方阅读器，也尚未提供任意本地 CBZ/ZIP 导入。
