...
describe('experimental Linux x64 package P5A', () => {
    ...
    it('ships and validates a rootless Linux desktop-menu install flow', () => {
        ...
        expect(install).toContain('.pica-library-install-root')
        expect(uninstall).toContain('target is not a recognized Pica Library Linux user install')
        ...
        expect(acceptance).toContain('uninstaller accepted an unrecognized application root')
