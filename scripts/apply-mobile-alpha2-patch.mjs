...
replaceOnce(
    ...
    "$('#language-select').onchange = (event) =>\n    applyLanguage(event.target.value, true)\n$('#mobile-bridge-refresh')?.addEventListener('click', () => void loadDesktop())\n"
)
