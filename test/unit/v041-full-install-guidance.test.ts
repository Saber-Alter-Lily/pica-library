...
describe('v0.4.1 full-package update guidance', () => {
    ...
    it('keeps v0.4.0 as the public upgrade baseline and points directly to the latest assistant', () => {
        ...
        for (const content of [guide, quick, readme]) {
            ...
            expect(content).toContain('v0.4.10')
        }

        expect(guide).toContain('Pica-Library-v0.4.10-upgrade-assistant.zip')
        expect(quick).toContain('Pica-Library-v0.4.10-upgrade-assistant.zip')
        ...
        expect(readme).not.toContain('v0.4.1 / v0.4.2 / v0.4.3 → v0.4.10')
        expect(quick).not.toContain('v0.4.1 / v0.4.2 / v0.4.3 → v0.4.10')
        expect(guide).not.toContain('### v0.4.1 / v0.4.2 / v0.4.3 → v0.4.10')
