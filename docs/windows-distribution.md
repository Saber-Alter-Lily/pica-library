...
### Public upgrade path: v0.4.0 → v0.4.8

Download from the **v0.4.8 Release**:

`Pica-Library-v0.4.8-upgrade-assistant.zip`

Extract it and run:

`Upgrade-Pica-Library-v0.4.8.cmd`
...
```powershell
Get-FileHash .\Pica-Library-v0.4.8-windows-x64.zip -Algorithm SHA256
```
