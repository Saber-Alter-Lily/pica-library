...
final class EhDownloadJobs {
    ...
    static void cancel(Context context,String comicId){MobileTaskPauseStore.setPaused(context,"download",name(comicId),false);WorkManager.getInstance(context.getApplicationContext()).cancelUniqueWork(name(comicId));}
