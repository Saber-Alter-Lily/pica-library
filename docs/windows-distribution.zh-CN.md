...
1. 从项目的 [GitHub Releases](https://github.com/Saber-Alter-Lily/pica-library/releases) 下载 `Pica-Library-v0.1.3-windows-x64.zip`。
...
```powershell
Get-FileHash .\Pica-Library-v0.1.3-windows-x64.zip -Algorithm SHA256
```
