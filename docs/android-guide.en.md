...
> Current stable release: **v0.4.9 · versionCode 52**. The Android app is not distributed through any app store. Download APKs only from this repository's official GitHub Release.

## 1. Download and install

1. Open [GitHub Releases](https://github.com/Saber-Alter-Lily/pica-library/releases/latest).
2. Download the current APK. For v0.4.9, use `Pica-Library-Android-v52.apk`.
...
Existing **v42 / 0.4.0** users can update in place directly to **v52 / 0.4.9** through the in-app update chain; no intermediate versions are required.
