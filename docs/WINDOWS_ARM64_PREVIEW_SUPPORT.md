...
12. keep formal distribution and self-update disabled.
...
- full-package candidate replacement and rollback using one external data root;
- any future schema-changing ARM64 preview migration/rollback;
