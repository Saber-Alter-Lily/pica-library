...
write('mobile/android-alpha2/app/src/main/java/com/picalibrary/android/NativeRecommendationStore.java', r'''
package com.picalibrary.android;
...
write('mobile/android-alpha2/app/src/main/java/com/picalibrary/android/RecommendationControlActivity.java', r'''
package com.picalibrary.android;
...
bridge = 'mobile/android-alpha2/app/src/main/java/com/picalibrary/android/BridgeClient.java'
regex_once(
    bridge,
    r'    static final class RecommendationItem \{.*?\n    \}\n    static final class RecommendationBatch',
...
regex_once(
    bridge,
    r'    static List<RecommendationItem> recommendations\(Context c,int limit\) throws Exception \{.*?\n    static JSONObject recommendationPolicy',
...
coordinator = 'src/recommendation-v3/cycle-coordinator-v3.ts'
replace_once(
    coordinator,
...
mobile_bridge = 'src/mobile/bridge-server.ts'
needle = """            if (
...
""" + needle
replace_once(mobile_bridge, needle, insertion)

write('test/unit/recommendation-v5-product-contract.test.ts', r'''
