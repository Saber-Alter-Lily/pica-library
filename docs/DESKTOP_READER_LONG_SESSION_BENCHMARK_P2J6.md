...
Status: **PASS / merged as PR #182 / no Reader memory or jank budget selected**

Accepted source/harness evidence before merge:
- Desktop Reader Long Session Harness run `36227293068`: PASS;
- P2 Runtime Hardening Promotion Gate run `36227292880`: PASS;
- Desktop Startup Harness run `36227293051`: PASS;
- Desktop Browser Home Harness run `36227292990`: PASS;
- Desktop Browser Detail Reader Harness run `36227293002`: PASS;
- Android Macrobenchmark Build run `36227292839`: PASS;
- normal CI run `36227292875`: PASS;
- Android memory/background regression run `36227292969`: PASS;
- Android force-stop regression run `36227292952`: PASS;
