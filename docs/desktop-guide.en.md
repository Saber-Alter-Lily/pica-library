...
> For Windows Desktop and the local Web UI. Current stable release: **v0.4.9**.
...
- **v0.4.0 → current release v0.4.9**: use `Pica-Library-v0.4.9-upgrade-assistant.zip` from the v0.4.9 Release and move directly to the latest release. No intermediate versions are required.
