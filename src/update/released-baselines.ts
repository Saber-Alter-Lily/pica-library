...
> = {
    ...
    '0.4.6': {
        ...
        actualMigrationVersion: 13,
        notes:
            'Public v0.4.6 keeps the schema-13 updater contract and is a compatible scoped-update baseline.'
    },
    '0.4.7': {
        version: '0.4.7',
        appApiVersion: 2,
        ...
        actualMigrationVersion: 13,
        notes:
            'Public v0.4.7 keeps the schema-13 updater contract and is a compatible scoped-update baseline.'
    },
    '0.4.8': {
        version: '0.4.8',
        appApiVersion: 2,
        ...
        actualMigrationVersion: 13,
        notes:
            'Public v0.4.8 keeps the schema-13 updater contract and is a compatible scoped-update baseline.'
    },
    '0.4.9': {
        version: '0.4.9',
        appApiVersion: 2,
