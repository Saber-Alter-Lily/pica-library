...
> For Windows Desktop and the local Web UI. Current stable release: **v0.4.8**.

## 1. Install and start

1. Download the current stable Windows package from [GitHub Releases](https://github.com/Saber-Alter-Lily/pica-library/releases/latest). For v0.4.8, use `Pica-Library-v0.4.8-windows-x64.zip`.
...
- **v0.4.0 → current release v0.4.8**: use `Pica-Library-v0.4.8-upgrade-assistant.zip` from the v0.4.8 Release and move directly to the latest release. No intermediate versions are required.
