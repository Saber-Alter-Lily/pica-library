...
public class ReadingHistoryStoreTest {
    ...
    @Test public void legacyChapterOrderIsOptionalAndBackwardCompatible(){ReadingHistoryStore.Legacy oldRow=new ReadingHistoryStore.Legacy("desktop","comic","ep","Title","Author","Chapter","pica","desktop",4,"2026-09-14T12:00:00Z","desktop");assertEquals(0,oldRow.chapterOrder);ReadingHistoryStore.Legacy rich=new ReadingHistoryStore.Legacy("desktop","comic","ep","Title","Author","Chapter 3",3,"pica","desktop",4,"2026-09-14T12:00:00Z","desktop");assertEquals(3,rich.chapterOrder);}
}
