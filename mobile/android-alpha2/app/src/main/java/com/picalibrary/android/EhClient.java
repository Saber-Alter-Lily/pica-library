...
final class EhClient {
    ...
    List<Page> pages(String comicId,int expectedPages,String surface) throws Exception {
        boolean exh="exh".equals(surface);if(exh&& !"AVAILABLE".equals(probeExH()))throw new SecurityException("当前 E-H 账号暂时无法访问 ExH");
