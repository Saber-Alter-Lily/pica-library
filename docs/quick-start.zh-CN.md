...
当前稳定版：**v0.4.8**。第一次使用 Windows 版通常只需要完成下载安装、首次设置、同步书库和按需配置推荐。
...
- 从 v0.4.8 Release 下载 `Pica-Library-v0.4.8-upgrade-assistant.zip`；
- 解压后运行 `Upgrade-Pica-Library-v0.4.8.cmd`；
- 无需安装任何中间版本。
