...
public class UnifiedLibraryFilterTest {
    ...
    @Test public void activeCountCountsFilterGroupsNotEveryChip(){UnifiedLibraryFilter.Spec spec=new UnifiedLibraryFilter.Spec();spec.sources.add(UnifiedLibraryFilter.Source.DESKTOP);spec.sources.add(UnifiedLibraryFilter.Source.WEBDAV);spec.tags.add("a");spec.tags.add("b");spec.favoriteOnly=true;spec.sort=UnifiedLibraryFilter.Sort.TITLE;assertEquals(4,spec.activeCount());}
