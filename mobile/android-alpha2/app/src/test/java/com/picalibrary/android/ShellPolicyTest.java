...
public class ShellPolicyTest {
    @Test public void acceptedBottomNavigationIsStable(){assertArrayEquals(new String[]{"书库","推荐","在线","设置"},ShellPolicy.bottomTabs());}
    ...
    @Test public void mobileShellDoesNotReintroduceProviderTabs(){for(String tab:ShellPolicy.bottomTabs()){assertNotEquals("图鉴",tab);assertNotEquals("Pica",tab);assertNotEquals("E-H",tab);assertNotEquals("ExH",tab);}}
