...
// Alpha7 has one integration entrypoint. Reuse the historical Mobile Bridge
// transforms and keep them idempotent as newer product surfaces land.
await import('./apply-mobile-alpha2-patch.mjs')
await import('./apply-mobile-recommendation-cache-patch.mjs')
await import('./apply-alpha8-update-patch.mjs')
await import('./apply-alpha8-desktop-version-patch.mjs')
await import('./apply-alpha8-recommendation-recovery-patch.mjs')
await import('./apply-alpha8-4-2-scroll-ranking-patch.mjs')
await import('./apply-alpha8-4-2-scroll-robustness-patch.mjs')
await import('./apply-alpha8-5-update-resilience-patch.mjs')
fs.copyFileSync(
    'docs/THEME_PACK_CREATOR_PROMPT.md',
    'web/theme-pack-creator-prompt.txt'
)
fs.copyFileSync('docs/THEME_PACK_SPEC_V1.md', 'web/theme-pack-spec-v1.txt')
...
function replaceOnce(file, before, after) {
    ...
    if (!source.includes(before))
        throw new Error(
            `Alpha7 patch anchor missing in ${file}: ${before.slice(0, 100)}`
        )
...
replaceOnce(
    ...
    '        <script type="module" src="./app.js"></script>\n        <script type="module" src="./alpha7-cloud.js"></script>\n        <script type="module" src="./alpha8-product.js"></script>\n        <script type="module" src="./alpha8-update-ui.js"></script>\n        <script type="module" src="./alpha8-theme-help.js"></script>\n        <script type="module" src="./alpha8-connections.js"></script>\n'
)

await import('./apply-alpha8-5-theme-studio-patch.mjs')
await import('./apply-alpha8-6-star-personalization-patch.mjs')
await import('./apply-alpha8-6-brand-resource-fix.mjs')
