...
从 [GitHub Releases](https://github.com/Saber-Alter-Lily/pica-library/releases/latest) 下载当前稳定版 Windows 完整包；v0.4.2 对应 `Pica-Library-v0.4.2-windows-x64.zip`。完整解压到普通文件夹，不要直接在压缩软件中运行。
...
- v0.4.1 → v0.4.2 属于兼容增量更新，可直接在软件内完成；如果仍为 v0.4.0，则使用 Release 中的 `Pica-Library-v0.4.2-upgrade-assistant.zip` 直接跨代升级。
