...
PICA_WEB_SMOKE_URL="${BASE_URL}" \
    pnpm exec playwright test test/e2e/web-smoke.spec.mjs test/e2e/localization-layout.spec.mjs test/e2e/onboarding.spec.mjs test/e2e/recommendation-controls.spec.mjs test/e2e/remote-web-readonly.spec.mjs \
