...
当前稳定版：**v0.4.5**。第一次使用 Windows 版通常只需要完成下载安装、首次设置、同步书库和按需配置推荐。
...
- 从 v0.4.5 Release 下载 `Pica-Library-v0.4.5-upgrade-assistant.zip`；
- 解压后运行 `Upgrade-Pica-Library-v0.4.5.cmd`；
- 无需安装任何中间版本。

升级助手会校验官方完整包、保护 `%LOCALAPPDATA%\\Pica Library`、备份旧程序和数据库、替换程序并执行健康检查；失败时自动回滚。

Android 已有 v42 / 0.4.0 用户可直接通过应用内更新链升级到 v48 / 0.4.4，无需安装中间版本。
