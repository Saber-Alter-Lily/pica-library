...
public final class WorkerForceStopRecoveryTest {
    private static final String HARNESS_PREFS = "p2-g15-worker-recovery";
    ...
    private static final String READY_FILE = "p2-g15-ready";

    private static final String PICA_ACTIVE_COMIC = "g15pactive";
    private static final String PICA_CANCELLED_COMIC = "g15pcancel";
    private static final String EH_PAUSED_COMIC = "g15ehpause";
    ...
    private static void verifyTerminalIdentityCleanup(Context app) {
        ...
        MobileTaskRegistryStore.registerDownload(app, "pica", "g15complete", "", UUID.randomUUID());
        PicaDownloadJobs.complete(app, "g15complete", "");
        assertNull(downloadRef(app, "pica", "g15complete", ""));
    }
